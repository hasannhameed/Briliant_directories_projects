...
$subBtn_sql    =    'SELECT * FROM `list_services` where profession_id = 3 AND master_id != 0';
$subcat_sql2   =    'SELECT * FROM `list_services` where profession_id = 3 AND master_id != 0 LIMIT 9';
                        ...
                        <div class="row ta-card-grid">
                            <?php
                                ...
                                $sql_string = mysql_query(
                                    ...
                                    WHERE ls.service_id = $service_id AND up.file = 'limage-1786737-298-photo.png'
                                    LIMIT 20;
                                    "
                                );
