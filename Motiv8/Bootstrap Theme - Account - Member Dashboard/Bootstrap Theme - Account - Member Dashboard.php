...
if($user_data['listing_type']=="Company"){
$photoTabText = "%%%account_listing_tab_2%%%";
}else{
	$photoTabText = "Profile Photo";
}
...
$contactDetailsTab = "<tr><td><a class='btn btn-block btn-" . $completed . " bold' href='/". $w['default_account_url'] ."/". $w['default_contact_url']."'>%%%account_listing_tab_1%%%</a></td></tr>";
...
if ($subscription['show_listing_details'] == 1) {
    ...
    $listingDetailsTab = "<tr><td><a class='btn btn-block btn-" . $completed . " bold' href='/". $w['default_account_url'] ."/". $w['default_resume_url']."'>%%%account_listing_tab_3%%%</a></td></tr>";
...
if ($subscription['show_about_tab'] == 1) {
    ...
    $aboutTab = "<tr><td><a class='btn btn-block btn-" . $completed . " bold' href='/". $w['default_account_url'] ."/". $w['default_about_url']."'>%%%account_listing_tab_4%%%</a></td></tr>";
...
if ($subscription['location_limit'] != 0 && $subscription['location_limit'] != '') {
    ...
    $serviceAreaTab = "<tr><td><a class='btn btn-block btn-" . $completed . " bold' href='/". $w['default_account_url'] ."/". $w['default_locations_url']."'>%%%account_listing_tab_5%%%</a></td></tr>";
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body" style="min-height: 290px;">
                    <table class="table nomargin table-links">
                        <tbody>
                            <?php if ($user_data['subscription_id'] == '30') { ?>
                                <!-- Supplier Card -->
                                <!--<tr>
                                    <td><a class="btn btn-block btn-success bold" href="/account/add-supplier-card/view">Booked Events</a></td>
                                </tr>-->
                                <!-- Supplier Card -->
                            <?php } ?>
							<tr>
							...
							<?php /*
                            <tr>
                                <td><a class="btn btn-block btn-success bold" href="/account/event-enquire">Event Enquiries</a></td>
                            </tr>
							 */ ?>
                            <tr>
                                <td><a class="btn btn-block btn-success bold" href="/account/my-promo">Event Credits</a></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body" style="min-height: 290px;">
                    <table class="table nomargin table-links">
                        <tbody>
                            <tr>
                                <td><a class="btn btn-block btn-success bold" href="/account/events-announcements/confirmed-events">Scheduled Events</a></td>
                            </tr>
                            <tr>
                                <td><a class="btn btn-block btn-success bold" href="/account/events-announcements/provisional-events">Waitlist Events</a></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="nomargin bold">
                        ...
                        <?php if ($user_data['subscription_id'] == '33' || $user_data['subscription_id'] == '30') {echo "Update Company "."%%%listing%%%"; }else{echo "%%%manage_label%%%";} ?> 
                    </h4>
                </div>
                <div class="panel-body" style="min-height: 290px;">
                    <table class="table nomargin table-links">
                        ...
                        if (isset($addonGoogleLogin['status']) && $addonGoogleLogin['status'] === 'success' && $allowGoogle == 1 && $allowGoogleLogin == 1 && $googleKeyValidation === true) {
                            if (empty($user_data['google_id'])) { ?>
                                <style>.table.nomargin.table-links td{padding: 8px 0;}</style>
