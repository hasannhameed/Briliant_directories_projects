<script src="/directory/cdn/assets/bootstrap/js/bootstrap-select.min.js"></script>
<script type="text/javascript" src="/directory/cdn/assets/bootstrap/js/jshashtable-2.1_src.min.js"></script>
<script type="text/javascript" src="/directory/cdn/assets/bootstrap/js/jquery.numberformatter-1.2.3.min.js"></script>
<script type="text/javascript" src="/directory/cdn/assets/bootstrap/js/tmpl.min.js"></script>
<script type="text/javascript" src="/directory/cdn/assets/bootstrap/js/jquery.dependClass-0.1.min.js"></script>
<script type="text/javascript" src="/directory/cdn/assets/bootstrap/js/draggable-0.1.min.js"></script>
<script type="text/javascript" src="/directory/cdn/assets/bootstrap/js/jQRangeSlider-min.js"></script>
<script src="/directory/cdn/assets/bootstrap/js/numeral.min.js"></script>  
<script>
<?php
...
?>
	...
	echo $slider_limits['slider_max'];
		...
		$(document).on("valuesChanging", ".jobs_slider", function (e, data) {
