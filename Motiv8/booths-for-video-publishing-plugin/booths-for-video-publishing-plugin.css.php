...
/* Scrollbar Styling */
.attendee_grid::-webkit-scrollbar {
    width: 6px;
}

.attendee_grid::-webkit-scrollbar-thumb {
    background: #888; /* Gray scrollbar */
    border-radius: 6px;
}

.attendee_grid::-webkit-scrollbar-thumb:hover {
    background: #555;
}
.attendee_grid:has(:nth-child(n+4)) {
    height: 130px; 
    overflow-y: auto;
    border-radius: 8px; 
...
span.count-supplier {
    ...
    padding: 6px;
        ...
        div.labels-container .edit-btn,  div.labels-container .deleteBtn {
            background: none;
            border: none;
            cursor: pointer;
			padding: 0px 4px;
