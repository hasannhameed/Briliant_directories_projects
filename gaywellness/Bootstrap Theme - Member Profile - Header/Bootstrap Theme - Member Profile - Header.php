<?php if ($user_data['profession_name'] == 'Gay Connect') { ?> 
<style>
h2, h3, h4, h5 {
    font-family: 'Nunito', sans-serif !important;
}

body, .modal-header, .modal-content, .modal-body, .modal-footer, .open {
    font-family: 'Nunito', sans-serif !important;
}
        ...
        <div class="row">
          ...
          if ($user[subscription_id] == '71') { ?>
			...
			<?php } ?>
				 ...
				 <?php
                     if ($user[subscription_id] == '87')  {
						 
						 if ($user['profession_name'] == 'Gay Connect') { 
                        echo '<span class=small profile-header-location><i class="fa fa-map-marker" style="color:#d77d64 ;"></i> '; }
...
<div class="text-center visible-xs-block" style="margin-top:15px;">
    <!-- Mobile: centered -->
    <div style="display:inline-block;">
        <div style="display:table;">
            <div class="col-xs-12 open " style="display:block; vertical-align:middle; padding-right:10px;">
                <strong>Open to</strong>
            </div>
            <div class="col-xs-12 open-lg gc-center-widget">
  [widget=Custom - Friends]
</div>
			...
			<div class="hidden-sm hidden-md hidden-lg hidden-xl ">    <div class="col-sm-12 tmargin xs-nomargin">
                ...
                <p class="line-height-xl nomargin" style="font-size: 16px;">
                    ...
                    if ($sub['profile_layout'] != "0" && (!empty($user['city']) || !empty($user['state_ln']) || !empty($user['zip_code']) || !empty($user['country_ln']))) {
						 ...
						 if ($user['profession_name'] == 'Gay Connect') {  
                        echo '<span class=small profile-header-location><i class="fa fa-map-marker" style="color:#0D3F4F ;"></i> Based in '; }
...
<div class="col-md-6">
 <?php
            //can send leads
            if ($sub['receive_messages'] != 1) { ?>
                <div class="rmargin tmargin profile-header-send-message">
                    <a class="chat-btn btn-block" title="%%%contact_label%%% <?php echo $user['full_name']; ?>" href="/<?php echo $user['filename']; ?>/<?php echo $w['default_connect_url'];?>">
                    <?php if ($w['enable_direct_chat_messages'] == "1" && $subscription['enable_direct_messages'] == "1") { ?>
                        <strong><i class="fa fa-commenting chat-icon" ></i>  Chat with me</strong>
                    <?php } else { ?>
...
<div class="col-md-6">
 ...
 <?php
            ...
            if ($sub['receive_messages'] != 1) { ?>
                <div class="rmargin tmargin profile-header-send-message">
                    <a class="like-btn btn-block " title="Favorite" href="/<?php echo $user['filename']; ?>/<?php echo $w['default_connect_url'];?>">
                    
                       <strong><i class="fa fa-heart like-icon"></i>&nbsp;Favorite</strong>
