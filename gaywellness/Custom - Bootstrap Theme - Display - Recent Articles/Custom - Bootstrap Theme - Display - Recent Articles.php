 ...
 */
$featureUrl = my-blog; // Use to Set the name of the Membership Feature this Streaming Widget will use. Can be controlled in the Design Settings.
...
if ($showFeature == true) { ?>
	...
	<div class="col-md-10 col-md-offset-1" style="margin-top:100px;">
			...
			<div class="clearfix"></div>                             
                            ...
                            <div class="col-sm-6 hidden-xs text-center bmargin " style="min-height: 275px; margin-top:30px;" >
